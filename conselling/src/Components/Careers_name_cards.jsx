import "./Careers_name_cards.css";
import { FaArrowRight } from "react-icons/fa";
function Careers_name_cards(params) {
  return (
    <>
        ...
        <div class="gradient-cards">
          <div class="card">
            <div class="container-card bg-green-box">
              ...
              <p class="card-title">Flim Director</p>
...
export default Careers_name_cards;
